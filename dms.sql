...
-- 导出  表 dms.dms_action 结构
CREATE TABLE IF NOT EXISTS `dms_action` (
...
-- 正在导出表  dms.dms_action 的数据：11 rows
DELETE FROM `dms_action`;
/*!40000 ALTER TABLE `dms_action` DISABLE KEYS */;
INSERT INTO `dms_action` (`id`, `name`, `title`, `remark`, `rule`, `log`, `type`, `status`, `update_time`) VALUES
...
/*!40000 ALTER TABLE `dms_action` ENABLE KEYS */;


-- 导出  表 dms.dms_action_log 结构
CREATE TABLE IF NOT EXISTS `dms_action_log` (
...
-- 正在导出表  dms.dms_action_log 的数据：0 rows
DELETE FROM `dms_action_log`;
/*!40000 ALTER TABLE `dms_action_log` DISABLE KEYS */;
INSERT INTO `dms_action_log` (`id`, `action_id`, `user_id`, `action_ip`, `model`, `record_id`, `remark`, `status`, `create_time`) VALUES
	(1, 1, 1, -1408237452, 'member', 1, 'dmism在2015-06-05 10:00登录了后台', 1, 1433469621),
	(2, 9, 1, -1408237452, 'channel', 3, '操作url：/dms/admin.php?s=/Channel/edit.html', 1, 1433471147),
	(3, 10, 1, -1408237452, 'Menu', 0, '操作url：/dms/admin.php?s=/Menu/del/id/93.html', 1, 1433471225);
/*!40000 ALTER TABLE `dms_action_log` ENABLE KEYS */;


-- 导出  表 dms.dms_addons 结构
CREATE TABLE IF NOT EXISTS `dms_addons` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- 正在导出表  dms.dms_addons 的数据：7 rows
DELETE FROM `dms_addons`;
/*!40000 ALTER TABLE `dms_addons` DISABLE KEYS */;
INSERT INTO `dms_addons` (`id`, `name`, `title`, `description`, `status`, `config`, `author`, `version`, `create_time`, `has_adminlist`) VALUES
...
/*!40000 ALTER TABLE `dms_addons` ENABLE KEYS */;


-- 导出  表 dms.dms_attachment 结构
...
-- 正在导出表  dms.dms_attachment 的数据：0 rows
DELETE FROM `dms_attachment`;
/*!40000 ALTER TABLE `dms_attachment` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_attachment` ENABLE KEYS */;


-- 导出  表 dms.dms_attribute 结构
CREATE TABLE IF NOT EXISTS `dms_attribute` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
-- 正在导出表  dms.dms_attribute 的数据：32 rows
DELETE FROM `dms_attribute`;
/*!40000 ALTER TABLE `dms_attribute` DISABLE KEYS */;
INSERT INTO `dms_attribute` (`id`, `name`, `title`, `field`, `type`, `value`, `remark`, `is_show`, `extra`, `model_id`, `is_must`, `status`, `update_time`, `create_time`, `validate_rule`, `validate_time`, `error_info`, `validate_type`, `auto_rule`, `auto_time`, `auto_type`) VALUES
...
/*!40000 ALTER TABLE `dms_attribute` ENABLE KEYS */;


-- 导出  表 dms.dms_auth_extend 结构
CREATE TABLE IF NOT EXISTS `dms_auth_extend` (
...
-- 正在导出表  dms.dms_auth_extend 的数据：8 rows
DELETE FROM `dms_auth_extend`;
/*!40000 ALTER TABLE `dms_auth_extend` DISABLE KEYS */;
INSERT INTO `dms_auth_extend` (`group_id`, `extend_id`, `type`) VALUES
	(1, 1, 1),
	(1, 1, 2),
	(1, 2, 1),
	(1, 2, 2),
	...
	(1, 4, 1),
	(1, 37, 1);
/*!40000 ALTER TABLE `dms_auth_extend` ENABLE KEYS */;


-- 导出  表 dms.dms_auth_group 结构
CREATE TABLE IF NOT EXISTS `dms_auth_group` (
...
-- 正在导出表  dms.dms_auth_group 的数据：2 rows
DELETE FROM `dms_auth_group`;
/*!40000 ALTER TABLE `dms_auth_group` DISABLE KEYS */;
INSERT INTO `dms_auth_group` (`id`, `module`, `type`, `title`, `description`, `status`, `rules`) VALUES
...
/*!40000 ALTER TABLE `dms_auth_group` ENABLE KEYS */;


-- 导出  表 dms.dms_auth_group_access 结构
CREATE TABLE IF NOT EXISTS `dms_auth_group_access` (
...
-- 正在导出表  dms.dms_auth_group_access 的数据：0 rows
DELETE FROM `dms_auth_group_access`;
/*!40000 ALTER TABLE `dms_auth_group_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_auth_group_access` ENABLE KEYS */;


-- 导出  表 dms.dms_auth_rule 结构
CREATE TABLE IF NOT EXISTS `dms_auth_rule` (
...
-- 正在导出表  dms.dms_auth_rule 的数据：213 rows
DELETE FROM `dms_auth_rule`;
/*!40000 ALTER TABLE `dms_auth_rule` DISABLE KEYS */;
INSERT INTO `dms_auth_rule` (`id`, `module`, `type`, `name`, `title`, `status`, `condition`) VALUES
...
/*!40000 ALTER TABLE `dms_auth_rule` ENABLE KEYS */;


-- 导出  表 dms.dms_category 结构
...
-- 正在导出表  dms.dms_category 的数据：2 rows
DELETE FROM `dms_category`;
/*!40000 ALTER TABLE `dms_category` DISABLE KEYS */;
INSERT INTO `dms_category` (`id`, `name`, `title`, `pid`, `sort`, `list_row`, `meta_title`, `keywords`, `description`, `template_index`, `template_lists`, `template_detail`, `template_edit`, `model`, `model_sub`, `type`, `link_id`, `allow_publish`, `display`, `reply`, `check`, `reply_model`, `extend`, `create_time`, `update_time`, `status`, `icon`, `groups`) VALUES
...
/*!40000 ALTER TABLE `dms_category` ENABLE KEYS */;


-- 导出  表 dms.dms_channel 结构
CREATE TABLE IF NOT EXISTS `dms_channel` (
...
-- 正在导出表  dms.dms_channel 的数据：3 rows
DELETE FROM `dms_channel`;
/*!40000 ALTER TABLE `dms_channel` DISABLE KEYS */;
INSERT INTO `dms_channel` (`id`, `pid`, `title`, `url`, `sort`, `create_time`, `update_time`, `status`, `target`) VALUES
	(1, 0, '首页', 'Index/index', 1, 1379475111, 1379923177, 1, 0),
	(2, 0, '博客', 'Article/index?category=blog', 2, 1379475131, 1379483713, 1, 0),
	(3, 0, '官网', 'http://www.dms.cn', 3, 1379475154, 1433471147, 1, 0);
/*!40000 ALTER TABLE `dms_channel` ENABLE KEYS */;


-- 导出  表 dms.dms_config 结构
...
-- 正在导出表  dms.dms_config 的数据：27 rows
DELETE FROM `dms_config`;
/*!40000 ALTER TABLE `dms_config` DISABLE KEYS */;
INSERT INTO `dms_config` (`id`, `name`, `type`, `title`, `group`, `extra`, `remark`, `create_time`, `update_time`, `status`, `value`, `sort`) VALUES
	(1, 'WEB_SITE_TITLE', 1, '网站标题', 1, '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '内容管理框架', 0),
	(2, 'WEB_SITE_DESCRIPTION', 2, '网站描述', 1, '', '网站搜索引擎描述', 1378898976, 1379235841, 1, '内容管理框架', 1),
	(3, 'WEB_SITE_KEYWORD', 2, '网站关键字', 1, '', '网站搜索引擎关键字', 1378898976, 1381390100, 1, '网站关键字', 8),
...
/*!40000 ALTER TABLE `dms_config` ENABLE KEYS */;


-- 导出  表 dms.dms_document 结构
...
-- 正在导出表  dms.dms_document 的数据：1 rows
DELETE FROM `dms_document`;
/*!40000 ALTER TABLE `dms_document` DISABLE KEYS */;
INSERT INTO `dms_document` (`id`, `uid`, `name`, `title`, `category_id`, `group_id`, `description`, `root`, `pid`, `model_id`, `type`, `position`, `link_id`, `cover_id`, `display`, `deadline`, `attach`, `view`, `comment`, `extend`, `level`, `create_time`, `update_time`, `status`) VALUES
...
-- 导出  表 dms.dms_document_article 结构
CREATE TABLE IF NOT EXISTS `dms_document_article` (
...
-- 正在导出表  dms.dms_document_article 的数据：1 rows
DELETE FROM `dms_document_article`;
/*!40000 ALTER TABLE `dms_document_article` DISABLE KEYS */;
INSERT INTO `dms_document_article` (`id`, `parse`, `content`, `template`, `bookmark`) VALUES
...
/*!40000 ALTER TABLE `dms_document_article` ENABLE KEYS */;


-- 导出  表 dms.dms_document_download 结构
CREATE TABLE IF NOT EXISTS `dms_document_download` (
  `id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '文档ID',
  `parse` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '内容解析类型',
...
-- 正在导出表  dms.dms_document_download 的数据：0 rows
DELETE FROM `dms_document_download`;
/*!40000 ALTER TABLE `dms_document_download` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_document_download` ENABLE KEYS */;


-- 导出  表 dms.dms_file 结构
...
-- 正在导出表  dms.dms_hooks 的数据：11 rows
DELETE FROM `dms_hooks`;
/*!40000 ALTER TABLE `dms_hooks` DISABLE KEYS */;
INSERT INTO `dms_hooks` (`id`, `name`, `description`, `type`, `update_time`, `addons`, `status`) VALUES
...
/*!40000 ALTER TABLE `dms_hooks` ENABLE KEYS */;


-- 导出  表 dms.dms_member 结构
CREATE TABLE IF NOT EXISTS `dms_member` (
...
-- 正在导出表  dms.dms_member 的数据：1 rows
DELETE FROM `dms_member`;
/*!40000 ALTER TABLE `dms_member` DISABLE KEYS */;
INSERT INTO `dms_member` (`uid`, `nickname`, `sex`, `birthday`, `qq`, `score`, `login`, `reg_ip`, `reg_time`, `last_login_ip`, `last_login_time`, `status`) VALUES
	(1, 'dmism', 0, '0000-00-00', '', 10, 2, 0, 1433468794, 2886729844, 1433469621, 1);
/*!40000 ALTER TABLE `dms_member` ENABLE KEYS */;


-- 导出  表 dms.dms_menu 结构
CREATE TABLE IF NOT EXISTS `dms_menu` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '文档ID',
...
-- 正在导出表  dms.dms_menu 的数据：111 rows
DELETE FROM `dms_menu`;
/*!40000 ALTER TABLE `dms_menu` DISABLE KEYS */;
INSERT INTO `dms_menu` (`id`, `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`, `status`) VALUES
...
/*!40000 ALTER TABLE `dms_menu` ENABLE KEYS */;


-- 导出  表 dms.dms_model 结构
CREATE TABLE IF NOT EXISTS `dms_model` (
...
-- 正在导出表  dms.dms_model 的数据：3 rows
DELETE FROM `dms_model`;
/*!40000 ALTER TABLE `dms_model` DISABLE KEYS */;
INSERT INTO `dms_model` (`id`, `name`, `title`, `extend`, `relation`, `need_pk`, `field_sort`, `field_group`, `attribute_list`, `attribute_alias`, `template_list`, `template_add`, `template_edit`, `list_grid`, `list_row`, `search_key`, `search_list`, `create_time`, `update_time`, `status`, `engine_type`) VALUES
...
/*!40000 ALTER TABLE `dms_model` ENABLE KEYS */;


-- 导出  表 dms.dms_picture 结构
CREATE TABLE IF NOT EXISTS `dms_picture` (
...
-- 正在导出表  dms.dms_picture 的数据：0 rows
DELETE FROM `dms_picture`;
/*!40000 ALTER TABLE `dms_picture` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_picture` ENABLE KEYS */;


-- 导出  表 dms.dms_ucenter_admin 结构
CREATE TABLE IF NOT EXISTS `dms_ucenter_admin` (
...
-- 正在导出表  dms.dms_ucenter_admin 的数据：0 rows
DELETE FROM `dms_ucenter_admin`;
/*!40000 ALTER TABLE `dms_ucenter_admin` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_ucenter_admin` ENABLE KEYS */;


-- 导出  表 dms.dms_ucenter_app 结构
CREATE TABLE IF NOT EXISTS `dms_ucenter_app` (
...
-- 正在导出表  dms.dms_ucenter_app 的数据：0 rows
DELETE FROM `dms_ucenter_app`;
/*!40000 ALTER TABLE `dms_ucenter_app` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_ucenter_app` ENABLE KEYS */;


-- 导出  表 dms.dms_ucenter_member 结构
CREATE TABLE IF NOT EXISTS `dms_ucenter_member` (
...
-- 正在导出表  dms.dms_ucenter_member 的数据：1 rows
DELETE FROM `dms_ucenter_member`;
/*!40000 ALTER TABLE `dms_ucenter_member` DISABLE KEYS */;
INSERT INTO `dms_ucenter_member` (`id`, `username`, `password`, `email`, `mobile`, `reg_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `update_time`, `status`) VALUES
	(1, 'dmism', 'f8d98eb8d42a0a5999ad74b3f030e83b', 'dmism@126.com', '', 1433468794, 2886729844, 1433469621, 2886729844, 1433468794, 1);
/*!40000 ALTER TABLE `dms_ucenter_member` ENABLE KEYS */;


-- 导出  表 dms.dms_ucenter_setting 结构
CREATE TABLE IF NOT EXISTS `dms_ucenter_setting` (
...
-- 正在导出表  dms.dms_ucenter_setting 的数据：0 rows
DELETE FROM `dms_ucenter_setting`;
/*!40000 ALTER TABLE `dms_ucenter_setting` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_ucenter_setting` ENABLE KEYS */;


-- 导出  表 dms.dms_url 结构
CREATE TABLE IF NOT EXISTS `dms_url` (
...
-- 正在导出表  dms.dms_url 的数据：0 rows
DELETE FROM `dms_url`;
/*!40000 ALTER TABLE `dms_url` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_url` ENABLE KEYS */;


-- 导出  表 dms.dms_userdata 结构
CREATE TABLE IF NOT EXISTS `dms_userdata` (
  `uid` int(10) unsigned NOT NULL COMMENT '用户id',
...
-- 正在导出表  dms.dms_userdata 的数据：0 rows
DELETE FROM `dms_userdata`;
/*!40000 ALTER TABLE `dms_userdata` DISABLE KEYS */;
/*!40000 ALTER TABLE `dms_userdata` ENABLE KEYS */;
